...
- **Purpose:** Persistent storage for blog_agent sessions and memory
...
**AGENT_NAME**
- **When:** Optional
- **Value:** Unique identifier (e.g., `my-blog_agent`)
- **Default:** `blog_agent`
...
**RELOAD_AGENTS**
- **Default:** `FALSE`
- **Purpose:** Enable blog_agent hot-reloading on file changes (development only)
