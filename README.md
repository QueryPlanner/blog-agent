...
**Philosophy**
We believe you should own your blog_agents. This template is designed to strip away the "cloud magic" and give you a clean, performant, and observable foundation that runs anywhere—from a $5/mo VPS to a Raspberry Pi cluster.
...
- **`AGENT_NAME`**: Unique ID for your blog_agent.
...
docker pull ghcr.io/queryplanner/blog-agent:main
...
The template comes pre-wired with **OpenTelemetry**. By default, it's set up to export traces to **Langfuse** for beautiful, actionable insights into your blog_agent's performance and costs.
